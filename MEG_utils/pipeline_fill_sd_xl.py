...
class StableDiffusionXLFillPipeline(DiffusionPipeline, StableDiffusionMixin, StableDiffusionXLLoraLoaderMixin):
    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                # Prepare extra step kwargs. Copied from StableDiffusionXLPipeline
                ...
                if i == len(timesteps) - 1 or (
                    ...
                    progress_bar.update()
                    image_0 = latents_to_rgb(latents)
